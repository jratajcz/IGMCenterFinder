...
def main():
	...
	parser.add_argument('-j', '--cart_input', action='store_true',
		help='CenterFinder will try to read a cartesian cloumns from input data '\
	...
	try:
		os.mkdir('out_{}'.format(filename_new))
	except FileExistsError:
		pass

	# creates and customizes instance of CenterFinder object
	cf = CenterFinder(args.file, args.weighted_input, args.cart_input,
	...
	cf.find_centers(dencon=dencon_args, cart=args.cart_input,
